    ...
    class Location {
        ...
        save() {
            if(!(this.lat_coord && this.long_coord))
            {
                ...
                if(!this.id) {
                    con.query("insert into locations " + insertClause, function (err, result, fields) {
                        if (err) {
                            return false;
                        }
                ...
                else
                {
                    ...
                    con.query("update locations set " + updateClause + "where id = " + this.id , function (err, result, fields) {
                        if (err) {
                            return false;
                        }
